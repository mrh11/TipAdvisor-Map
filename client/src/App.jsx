...
//     Axios.get('/api/locations/29')
//     .then(({data}) => {
//       let {hotel, Address, City, Country, Lat, Long, id} = data[0];
//       setHotel([hotel, Address, City, Country, Lat, Long, id])
//     })
//     .catch((err) => {console.log(err)});
//   })
...
//         {(this.state.clickState) 
//           ? <div>
//             <div className="R_container" onClick={()=>{this.updateClickState()}}>
//               <img className="R_image" src={`https://s3.amazonaws.com/fec-map/${this.state.id}.png`} alt="No Image Found"/>
//               <div className="R_overlay">
//                 <a href="http://chittagongit.com/images/full-screen-icon-png/full-screen-icon-png-17.jpg" className="R_icon" title="User Profile"/>
//               </div>
//             </div>
//             <div className="R_wrapper">
//             <div className="R_overview">Overview
